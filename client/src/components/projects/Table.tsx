...
interface DataTableProps<ProjectData, TValue> {
    columns: ColumnDef<ProjectData, TValue>[];
    data: ProjectData[];
}

export function ProjectsTable<TValue>({ columns, data }: DataTableProps<ProjectData, TValue>) {
